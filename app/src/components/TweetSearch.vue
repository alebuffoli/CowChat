...
<template>
    <div class="relative border-b">
        <input
            type="text"
            class="text-gray-700 w-full pl-16 pr-32 py-4 bg-gray-50 dark:bg-transparent dark:text-gray-50"
        ...
        <div class="absolute right-0 inset-y-0 flex items-center pr-8">
            <button
                class="rounded-full px-4 py-1  font-semibold dark:bg-brandeis-blue dark:text-gray-50"
